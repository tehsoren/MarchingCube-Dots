...
//https://github.com/JimmyCushnie/Noisy-Nodes/tree/master/NoiseShader
...
void VoronoiPrecise3D_float(float3 UV, float AngleOffset, float CellDensity, out float Out, out float Cells,out float Center) {
